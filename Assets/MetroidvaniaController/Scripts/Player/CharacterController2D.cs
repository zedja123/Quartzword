...
public class CharacterController2D : MonoBehaviour
{
	...
	[SerializeField] public Slider sliderExtraEnergy;
	...
	public float life = 100;//Life of the player
    ...
    private void Update()
    {
		...
		{
			ApplyDamage(100f, new Vector3(0, 0, 0));
		}
	...
	/*public void SetMaxExtraEnergy()
	{
		sliderExtraEnergy.maxValue = maxExtraEnergy;
		sliderExtraEnergy.value = extraEnergy;
	}
	public void SetExtraEnergy()
	{
		sliderExtraEnergy.value = extraEnergy;
	}*/
